...
public class AopdemoApplication {
    ...
    */
    ...
    public CommandLineRunner commandLineRunner(AccountDAO theAccountDAO,
                                               ...
                                               TrafficFortuneService theTrafficFortuneService) {// Spring Boot will inject the dependency AccountDAO automatically because of @Bean | When using @Bean for a method such as commandLineRunner, Spring will check the arguments to the method. Spring will resolve the method arguments by injecting the appropriate Spring Bean. In this case, there is no need to use @Autowired. Spring will inject the beans automatically behind the scenes.
        return runner -> {
...
//        theAccountDAO.setName("Biswajit");
//        System.out.println(theAccountDAO.getName());
//        theAccountDAO.setServiceCode("SP");
