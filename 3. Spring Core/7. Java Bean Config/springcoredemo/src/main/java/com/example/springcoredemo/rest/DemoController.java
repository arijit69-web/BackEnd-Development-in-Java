...
public class DemoController {
    ...
    @Autowired
    public DemoController(@Qualifier("Aquatic") Coach theCoach) { // In the case of multiple Coach implementations. We resolved it using @Qualifier. We specified a coach by name.
